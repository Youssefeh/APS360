...
base_data_path = r"C:/Users/14165/Desktop/APS360/APS360/FinalDataset"
base_resnet_path = r"C:/Users/14165/Desktop/APS360/APS360/AlexNet/"

classes = os.listdir(base_data_path + r"/train")
print(classes)
...
def save_features(data_loader, data_name):
    ...
    for img, label in data_loader:
        features = resnet.features(img)
        features_tensor = torch.from_numpy(features.detach().numpy())

        path = f"{base_resnet_path}{data_name}/{classes[label]}"
...
train_data_resnet = torchvision.datasets.DatasetFolder(base_resnet_path + "train", loader=torch.load, extensions=('.tensor'))
valid_data_resnet = torchvision.datasets.DatasetFolder(base_resnet_path + "val", loader=torch.load, extensions=('.tensor'))
test_data_resnet = torchvision.datasets.DatasetFolder(base_resnet_path + "test", loader=torch.load, extensions=('.tensor'))
...
#proper model
train_transfer(model, train_data_resnet, valid_data_resnet, batch_size = 256, learning_rate = 0.01, num_epochs=15)
