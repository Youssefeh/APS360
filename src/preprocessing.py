...
def getLoaders(batch_size=64):
    ...
    train_loader = torch.utils.data.DataLoader(train_set,num_workers =0, batch_size=batch_size, shuffle=True)
    val_loader = torch.utils.data.DataLoader(validation_set,num_workers =0, batch_size=batch_size, shuffle=True)
    test_loader = torch.utils.data.DataLoader(testing_set,num_workers =0, batch_size=batch_size, shuffle=True)
